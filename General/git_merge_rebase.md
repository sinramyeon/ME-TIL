...
content of the current brrarnch(HEAD : ref is pointing to)
<<<<<<< HEAD
잉잉이
=======
content in the branch being merged. >>>>>> 어쩌구 iss the content in the brranch being merged.
=======
징징이
>>>>>>> 어쩌구
git merge options
...
Tip of Rebase
the most important thing to learn is when not to do it. The golden rule of git rebase is to never use it on public branches.
...
re-writes the changes of one branch onto another branch without the creation of a merge commit.
...
Preserves complete history and chronological order.
Maintains the context of the branch.
Markdown 6032 bytes 892 words 165 lines Ln 153, Col 38HTML 4211 characters 848 words 78 paragraphs
